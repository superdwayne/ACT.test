      ...
      <div className="flex-1">
        ...
        <main className="container mx-auto px-4 py-6">
          <div className="mb-6 flex items-center justify-between gap-2">
            <div>
              <h2 className="text-xl font-semibold tracking-tight">Obra Dashboard (Dark)</h2>
              <p className="text-sm text-muted-foreground">Dark surface tokens, subtle borders, balanced spacing</p>
            </div>
          ...
          <Alert className="mb-6">
            <AlertTitle>Theme</AlertTitle>
            <AlertDescription>
              This route forces the dark theme using next-themes and your semantic tokens.
            </AlertDescription>
          </Alert>
              ...
              <Card>
                ...
                <CardContent className="grid gap-4">
                  <div className="space-y-2">
                    <Label>Theme</Label>
                    <Select defaultValue="dark" onValueChange={(v) => setTheme(v)}>
                      <SelectTrigger>
