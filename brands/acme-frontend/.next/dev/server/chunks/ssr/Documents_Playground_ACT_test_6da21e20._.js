module.exports = [
"[project]/Documents/Playground/ACT.test/packages/auth/dist/components/index.js [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
(()=>{
    const e = new Error("Cannot find module './login-form'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './signup-form'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './reset-password-form'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
'use client';
...
//# sourceMappingURL=Documents_Playground_ACT_test_6da21e20._.js.map