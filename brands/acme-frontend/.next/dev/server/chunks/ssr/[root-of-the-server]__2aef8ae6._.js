...
var signUpSchema = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Playground$2f$ACT$2e$test$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    brandId: __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Playground$2f$ACT$2e$test$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1).optional(),
            ...
            if (user) {
                ...
                if (userBrandId) {
                    ...
                    setAuthState({
                        user,
                        loading: false,
                        brand: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Playground$2f$ACT$2e$test$2f$packages$2f$tenant$2d$config$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBrandConfig"])(userBrandId)
                    });
                } else {
                    setAuthState({
                        user,
                        loading: false,
                        brand: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Playground$2f$ACT$2e$test$2f$packages$2f$tenant$2d$config$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBrandConfig"])(defaultBrandId)
                    });
                }
            } else {
                setAuthState({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2aef8ae6._.js.map