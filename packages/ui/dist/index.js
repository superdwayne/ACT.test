// src/index.ts
import { cn as cn4 } from "@act/utils";

// src/components/button.tsx
import * as React from "react";
import { Slot } from "@radix-ui/react-slot";
import { cva } from "class-variance-authority";
import { cn } from "@act/utils";
...
import { cn as cn2 } from "@act/utils";
...
import { cn as cn3 } from "@act/utils";
...
var CardHeader = React3.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx3(
  ...
  {
    ref,
    className: cn3("flex flex-col space-y-1.5 p-6", className),
    ...props
  }
));
...
var CardContent = React3.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx3("div", { ref, className: cn3("p-6 pt-0", className), ...props }));
CardContent.displayName = "CardContent";
var CardFooter = React3.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx3(
  "div",
  {
    ref,
    className: cn3("flex items-center p-6 pt-0", className),
    ...props
  }
));
